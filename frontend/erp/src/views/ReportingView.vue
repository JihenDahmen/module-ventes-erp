...
.card {
  background-color: #333; /* Slightly lighter than page bg */
  padding: 1.5rem;
  border-radius: 8px;
...
.kpi .subtitle { font-size: 0.8rem; color: #888; margin-top: 0.25rem; }

table { width: 100%; border-collapse: collapse; margin-top: 1rem; }
th, td { text-align: left; padding: 0.75rem 0; border-bottom: 1px solid #444; }
...
.loading, .error { padding: 2rem; text-align: center; font-size: 1.2rem; border: 1px dashed #444; }
.error { color: #ff4444; }
</style>
